function getInputValue(){
    ...
    if (flower === 'rose') {
        ...
        picture.src = '../img/flower/flower-rose.jpg';
    }
        ...
        picture.src = '../img/flower/flower-tulip.jpg';
    } 
    else if(flower === 'lily'){
        ...
        picture.src = '../img/flower/flower-lily.jpg';
    }   
        ...
        picture.src = '../img/flower/flower-lotus.jpg';
    } 
        ...
        picture.src = '../img/flower/flower-orchid.jpg';
    } 
        ...
        picture.src = '../img/flower/flower-magnolia.jpg';
    } 
        ...
        picture.src = '../img/flower/flower-carnation.jpg';
    } 
    else {
        textDisplay.innerHTML = "Sorry, No Flower Image Available";
        picture.src = "../img/flower/flower-bouquet.jpg"
    }
}